...
/// "Semester — Timetable": today's lessons as a scrollable list fed by
/// WidgetDataService
class TimetableWidgetProvider : SemesterWidgetProvider() {
    override fun render(
        ...
        val day = payload(prefs, "timetable").optString("day", "")
        views.setTextViewText(R.id.widget_meta, day)
        views.setTextColor(R.id.widget_meta, c.soft)

        views.setRemoteAdapter(R.id.rows, widgetDataService(context, "timetable"))
